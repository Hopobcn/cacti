...
public:
    Htree2(enum Wire_type wire_model, double mat_w, double mat_h, int add, int data_in, int data_out, int bl, int wl,
            enum Htree_type h_type, bool uca_tree = false, TechnologyParameter::DeviceType* dt = &(g_tp.peri_global));
