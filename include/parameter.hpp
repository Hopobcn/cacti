...
public:
    ...
    public:
        ...
        DeviceType()
                : C_g_ideal(0), C_fringe(0), C_overlap(0), C_junc(0), C_junc_sidewall(0), l_phy(0), l_elec(0),
                  R_nch_on(0), R_pch_on(0), Vdd(0), Vth(0), I_on_n(0), I_on_p(0), I_off_n(0), I_off_p(0), C_ox(0),
                  t_ox(0), n_to_p_eff_curr_drv_ratio(0) {
        };
...
public:
    ...
    DynamicParameter();
    DynamicParameter(bool is_tag, int pure_ram, double Nspd, unsigned int Ndwl, unsigned int Ndbl, unsigned int Ndcm,
            unsigned int Ndsam_lev_1, unsigned int Ndsam_lev_2, bool is_main_mem);
